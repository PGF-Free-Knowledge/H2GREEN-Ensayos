...
void loop() {
  ...
  if (slaveF.available()) {
    ...
    if (sep > 0) {
      ...
      F = partF.substring(2).toFloat();
      SP_D = partSP.substring(5).toFloat();
    }
  }

  // ===================================================
  // ENVIAR SP_D AL ESCLAVO DESPLAZAMIENTO
  // ===================================================
  slaveD.listen();
  slaveD.print("SP_D=");
  ...
  Serial.print(";D=");//prueba
  Serial.print(D, 2);//prueba

  Serial.print(";SPD=");//prueba
  Serial.print(SP_D, 2);//prueba
