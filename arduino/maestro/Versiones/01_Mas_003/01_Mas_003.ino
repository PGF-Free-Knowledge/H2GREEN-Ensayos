...
void setup() {
  ...
  Serial.println("Sistema Maestro sincronizado");
...
void loop() {
  ...
  // ===============================
  // CONTROL DE CICLO FIJO
  // ===============================
  if (millis() - inicio_ciclo < ciclo_ms)
    return;
  ...
  // ===============================
  // 2️⃣ ENVIAR D Y SP_F AL ESCLAVO FUERZA
  // ===============================
  slaveF.listen();
