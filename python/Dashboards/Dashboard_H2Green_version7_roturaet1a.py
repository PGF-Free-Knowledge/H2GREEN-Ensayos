...
# =============================== agregado    
    ...
    def update_data(self,t,F,D,P1,P2,T,estado):# modificación de update
        ...
        if self.R_alcanzado == False:
            if self.F_max_registrada > 0 and F < self.F_max_registrada:
                self.R_alcanzado = True
                print("CAIDA DESPUES DE R")
