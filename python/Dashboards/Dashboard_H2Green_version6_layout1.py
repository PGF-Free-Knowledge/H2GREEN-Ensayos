...
class Dashboard(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        ensayo_layout.addWidget(QtWidgets.QLabel("Operación Automática"))

        ensayo_layout.addSpacing(10)
       
        ensayo_layout.addWidget(QtWidgets.QLabel("Operación Manual"))

        ensayo_layout.addSpacing(10)

        ensayo_layout.addWidget(QtWidgets.QLabel("Emergencia"))
