...
class DigitalDisplay(QtWidgets.QFrame):
    ...
    def __init__(self,titulo,unidad):
        ...
        self.label_valor.setStyleSheet("color:#00ff00;font-size:22px")
...
class Dashboard(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        "El actuador es controlado mediante motor stepper para aplicar "
        "velocidad de carga constante durante el ensayo."
        )
