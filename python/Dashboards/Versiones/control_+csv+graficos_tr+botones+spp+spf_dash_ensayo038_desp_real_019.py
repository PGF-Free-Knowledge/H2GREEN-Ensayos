...
# ===============================
    ...
    def abortar(self):
        ...
        self.en_exposicion = False # hasta acá

        # después de 5 segundos pasar a detenido
        QtCore.QTimer.singleShot(5000, self.detener_estado)

    def detener_estado(self): # se agrega posterior a la función abortar

        self.serial.send_command("PURGE_OFF")

        # Refuerzo visual (opcional pero recomendado),para asegurar coherencia visual
