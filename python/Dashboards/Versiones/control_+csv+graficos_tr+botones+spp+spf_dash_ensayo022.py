...
class Dashboard(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Sistema de Ensayo - Control por Velocidad")
        ...
        control_vel = QtWidgets.QHBoxLayout()
        main_layout.addLayout(control_vel)
        ...
        control_vel.addWidget(self.input_vel)
        control_vel.addWidget(self.btn_set_vel)
