...
class Dashboard(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        "Sistema con corte automático por fuerza máxima\n"
        "Incluye curva Fuerza vs Desplazamiento"
        )
        ...
        self.plot_fd.setLabel('left', 'Fuerza', 'kN')
        self.plot_fd.setLabel('bottom', 'Desplazamiento', 'mm')
